...
const char* thingsBoardUrl = "http://45.138.132.164:8080/api/plugins/telemetry/DEVICE/c91fbb80-1c9c-11ee-a44e-b9f1484bae02/values/timeseries?keys=lightStatus,control_key";
const char* authUrl = "http://45.138.132.164:8080/api/auth/login";
const char* sendDataPath = "http://45.138.132.164:8080/api/v1/esp82/telemetry";
...
Serial.println(error.f_str());
  ...
  delay(10);
  digitalWrite(RELAY_PIN, state == "off");
